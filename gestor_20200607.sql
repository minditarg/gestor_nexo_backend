...
INSERT INTO `pages` VALUES (1,'pagina1','pagina de inico',0),(2,'Pagina2','holaaaasss',0),(3,'pagina 3','pagina de inicio nueva',1),(4,'pagina 5','pagina secundaria',1),(5,'pagina noticias','noticias',1),(6,'Psicologia','Pagina de prueba Psicologia',1),(7,'pagina home','pagina principal',1);
...
INSERT INTO `tags` VALUES (1,NULL,NULL),(13,3,'hola'),(14,3,'matias'),(15,3,'jime'),(16,NULL,'hola'),(17,NULL,'alooo'),(18,NULL,'hola'),(19,NULL,'matias'),(20,NULL,'nicolas'),(26,6,'nicolas'),(27,6,'matu'),(28,6,'hola'),(33,7,'hola'),(35,8,'matias'),(36,8,'Schindler\'s List'),(37,9,'matii'),(38,10,'matias'),(39,10,'imagen'),(40,11,'matias'),(41,11,'imagen'),(48,13,'tag1'),(49,13,'daniel'),(50,13,'The Godfather'),(51,13,'The Godfather: Part II'),(60,14,'hola'),(61,14,'matias'),(62,15,'The Godfather'),(64,16,'The Godfather'),(66,17,'The Shawshank Redemption'),(70,19,'The Shawshank Redemption'),(71,20,'The Shawshank Redemption'),(72,21,'The Shawshank Redemption');
...
INSERT INTO `tipos_categorias` VALUES (1,' FIN DE LA POBREZA',0),(2,'HAMBRE CERO',0),(3,'SALUD Y BIENESTAR',0),(4,'EDUCACIÓN DE CALIDAD',0),(5,'IGUALDAD DE GÉNERO',0),(6,'AGUA LIMPIA Y SANEAMIENTO',0),(7,'ENERGÍA ASEQUIBLE Y NO CONTAMINANTE',0),(8,'TRABAJO DECENTE Y CRECIMIENTO ECONÓMICO',0),(9,'INDUSTRIA INNOVACIÓN E INFRAESTRUCTURA',0),(10,'REDUCCIÓN DE LAS DESIGUALDADES',0),(11,'CIUDADES Y COMUNIDADES SOSTENIBLES',0),(12,'PRODUCCIÓN Y CONSUMO RESPONSABLES',0),(13,'ACCIÓN POR EL CLIMA',0),(14,'VIDA SUBMARINA',0),(15,'VIDA DE ECOSISTEMAS TERRESTRES',0),(16,'PAZ, JUSTICIA E INSTITUCIONES SÓLIDAS',0),(17,'ALIANZAS PARA LOGRAR OBJETIVOS',0);
...
INSERT INTO `types_modules` VALUES (1,'Psi Slider Principal'),(2,'Psi About'),(3,'Psi Titulo,Texto'),(4,'Psi Titulo, Texto Alternativo'),(5,'Psi Titulo,imagen Listo de Items'),(6,'Portada Noticias'),(7,'Portada Actividades'),(8,'Portada Campañas'),(9,'quienes somos');
...
/*!50003 SET character_set_results = @saved_cs_results */ ;
/*!50003 SET collation_connection  = @saved_col_connection */ ;
/*!50003 DROP PROCEDURE IF EXISTS `noticias_categorias_tipos_list` */;
/*!50003 SET @saved_cs_client      = @@character_set_client */ ;
/*!50003 SET @saved_cs_results     = @@character_set_results */ ;
/*!50003 SET @saved_col_connection = @@collation_connection */ ;
...
DELIMITER ;;
CREATE DEFINER=`root`@`%` PROCEDURE `noticias_categorias_tipos_list`()
BEGIN
SELECT * FROM tipos_categorias;
...
SELECT n.*, tc.descripcion as descripcion_tipo_categoria,tn.descripcion as descripcion_tipo_noticia, u.nombre as nombre_user 
FROM noticias n 
LEFT JOIN tipos_categorias tc ON tc.id = n.id_tipo_categoria  
...
INSERT INTO noticias (nombre,descripcion,id_tipo_noticia,id_tipo_categoria,id_user,fecha_creacion,fecha_publicacion,fecha_finalizacion,contenido,estado)
VALUES(i_nombre,i_descripcion,i_id_tipo_noticia,i_id_tipo_categoria,i_id_user,NOW(),var_fecha_publicacion,i_fecha_finalizacion,i_contenido,i_estado);
...
SELECT n.*, tc.descripcion as decripcion_tipo_categoria,tn.descripcion as descripcion_tipo_noticia, u.nombre as nombre_user 
FROM noticias n 
LEFT JOIN tipos_categorias tc ON tc.id = n.id_tipo_categoria  
LEFT JOIN tipos_noticias tn ON tn.id = n.id_tipo_noticia
LEFT JOIN users u ON u.id = n.id_user
...
UPDATE noticias SET nombre = i_nombre,descripcion = i_descripcion,id_tipo_noticia = i_id_tipo_noticia, id_tipo_categoria = i_id_tipo_categoria, id_user = i_id_user,fecha_finalizacion = i_fecha_finalizacion,contenido = i_contenido, estado = i_estado
...
-- Dump completed on 2020-06-08  0:07:05
